...
void Entity::PopulateDataMap() {
    int offset = 0;
    data_vec.push_back({offset, "pos_x_accel", data.pos_x_accel});
    offset += sizeof(data.pos_x_accel);
    data_vec.push_back({offset, "pos_x", data.pos_x});
    offset += sizeof(data.pos_x);
    data_vec.push_back({offset, "pos_y_accel", data.pos_y_accel});
    offset += sizeof(data.pos_y_accel);
    ...
    data_vec.push_back({offset, "offset_x", data.offset_x});
    offset += sizeof(data.offset_x);
    data_vec.push_back({offset, "offset_y", data.offset_y});
    offset += sizeof(data.offset_y);
    ...
    data_vec.push_back({offset, "color_flags", data.color_flags});
    offset += sizeof(data.color_flags);
    ...
    data_vec.push_back({offset, "unk3C", data.unk3C});
    offset += sizeof(data.unk3C);
    ...
    data_vec.push_back({offset, "unk5C", data.unk5C});
    offset += sizeof(data.unk5C);
    data_vec.push_back({offset, "unk60", data.unk60});
    offset += sizeof(data.unk60);
    data_vec.push_back({offset, "polygt4_id", data.polygt4_id});
    offset += sizeof(data.polygt4_id);
