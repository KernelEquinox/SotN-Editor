...
enum ImGuiColorEditFlags_
{
    ...
    // Custom flag to force the checkerboard not to display
    ImGuiColorEditFlags_NoCheckerboard  = 1 << 29,  //              // ColorEdit, ColorPicker, ColorButton: don't display the checkerboard for alpha component
