...
bool ImGui::ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, const ImVec2& size_arg)
{
    ...
    else
    {
        ...
        // Custom override to force transparency without checkerboard in order to create outline buttons
        //if (col_source.w < 1.0f)
        if (col_source.w < 1.0f && !(flags & ImGuiColorEditFlags_NoCheckerboard))
